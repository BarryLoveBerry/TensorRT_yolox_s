...
int Int8EntropyCalibrator2::getBatchSize() const TRTNOEXCEPT
{
    return batchsize_;
}

bool Int8EntropyCalibrator2::getBatch(void* bindings[], const char* names[], int nbBindings) TRTNOEXCEPT
{
    // std::cout<< "getbatch done"<<std::endl;
...
const void* Int8EntropyCalibrator2::readCalibrationCache(size_t& length) TRTNOEXCEPT
{
...
void Int8EntropyCalibrator2::writeCalibrationCache(const void* cache, size_t length) TRTNOEXCEPT
{
